...
st.markdown(
    '<p style="margin-top: -20px;">Extract LaTeX code from images using Llama 3.2 Vision!</p>',
...
st.markdown("---")
st.markdown(
    "Made by Senhadji Said using Llama Vision Model2 | [Report an Issue](https://github.com/SenhadjiMSaid/LaTex-reader/issues)"
)
